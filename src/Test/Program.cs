...
{
    /// <summary>
    /// Interactive console for exercising IpMatcher by hand.
    ///
    /// Automated coverage lives in the Touchstone-based projects (Test.Shared is the
    /// central source of truth, exposed via Test.Automated, Test.Xunit, and Test.Nunit).
    /// This project intentionally remains an interactive REPL for manual exploration.
    /// </summary>
